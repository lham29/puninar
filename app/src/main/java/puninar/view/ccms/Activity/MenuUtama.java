...
import puninar.view.ccms.Utility.TabFragment;
...
public class MenuUtama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernamenav = (TextView)header.findViewById(R.id.nav_username);

        SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        String email = sharedPreferences.getString(Config.EMAIL_SHARED_PREF,"Not Available");
        usernamenav.setText(email);

        //Intent intent = getIntent();
        //usernamenav.setText(intent.getStringExtra(LoginActivity.email);

        //SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        //String email = sharedPreferences.getString(Config.EMAIL_SHARED_PREF,"Not Available");

        //Showing the current logged in email to textview
        //usernamenav.setText("Current User: " + email);
        /**
